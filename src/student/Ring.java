 ...
 * Provided.
 *
 * A ring is represented by a circle, which defines the inner part of the shape, and a thickness.
 */
...
public class Ring {
    ...
    /**
     * Create a new Student.Ring, takes a Student.Circle to serve as the inner circles, and a double to serve as the thickness.
