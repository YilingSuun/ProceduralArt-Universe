 ...
 * <pre>
 *     Student.ShapeDrawer myDraw = new Student.ShapeDrawer(100, 120); // 100 wide, 120 tall
 *     // create shape objects
 *     Student.Circle c = new Student.Circle(new Student.Point(50,60), 40);
 *     // and draw them
 *     myDraw.draw(c);
 *     // when done save it:
...
public class ShapeDrawer {
     ...
     * For more information see: <a href="https://docs.oracle.com/javase/10/docs/api/java/awt/Color.html">...</a>
     */
